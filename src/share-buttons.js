(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('ShareButtons', [], factory);
        //console.log('AMD');
    } else if (typeof exports === "object") {
        module.exports = factory(window, document);
        //console.log('Node, CommonJS-like');
    } else {
        // console.log('Browser globals (root is window)');
        root.ShareButtons = factory(window, document);
    ...
    function ShareButtons(data) {
        ...
        var option = Object.assign({}, def, data || {});
        ...
        var FB_LINK_FORMAT = 'https://www.facebook.com/sharer/sharer.php?u={0}',
            ...
            VI_LINK_FORMAT = 'viber://forward?text={0}%20{1}',
            ...
            MY_LINK_FORMAT = 'https://connect.mail.ru/share?url={0}&title={1}',
            LJ_LINK_FORMAT = 'https://www.livejournal.com/update.bml?subject={0}&event={1}',
            FB_CLASS_NAME = 'fb',
            VK_CLASS_NAME = 'vk',
            TW_CLASS_NAME = 'tw',
            TG_CLASS_NAME = 'tg',
         ...
         */
        var init = function () {
            var i, share = d.querySelectorAll(option.elementID);
        ...
        var share = function (id, urlDef, titleDef, descDef) {
            ...
            switch (id) {
                ...
                case LJ_CLASS_NAME:
                    popupCenter(
                        stringFormat(LJ_LINK_FORMAT, [
                            title,
                            mergeForTitle([url, desc ? desc : title])
                        ]),
                        titleDef);
                    break;
                ...
                case FAV_CLASS_NAME:
                    ...
                    if (isMac || isWebkit) { // Webkit (Chrome, Opera), Mac
                        ...
                        if (typeof option.erroMsgFunc == "function") {
                            option.erroMsgFunc('Нажмите "' + (isMac ? 'Command/Cmd' : 'Ctrl') + ' + D" для добавления страницы в закладки');
                        } else {
